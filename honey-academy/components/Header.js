    ...
    <header className="bg-white/80 backdrop-blur-lg sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link
            href="#contact"
            className="hidden md:inline-block bg-amber-500 text-white font-semibold px-6 py-2 rounded-full cta-button hover:bg-amber-600"
          >
            Enroll Now
          </Link>
          <button
      ...
      {isOpen && (
        <div className="md:hidden px-6 pb-4">
          ...
          <Link
            href="#contact"
            className="block mt-4 bg-amber-500 text-white text-center font-semibold px-6 py-2 rounded-full cta-button hover:bg-amber-600"
            onClick={() => setIsOpen(false)}
          >
            Enroll Now
          </Link>
